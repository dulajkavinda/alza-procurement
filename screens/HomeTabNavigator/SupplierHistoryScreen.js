...
import { List, ListItem, Body, Right, Button, Left } from "native-base";
...
class SupplierOrderScreen extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      seed: 1,
  ...
  loadOrders = () => {
    ...
    const query = { orderstate: { $eq: "completed" } };
    let itemsCollection = mongoClient
      .db("alzaproc")
      ...
      <List style={style.scene}>
        ...
        <Modal isVisible={this.state.isModalSuccessVisible}>
          <View style={style.modalStyle}>
            ...
            >
              <Ionicons name="ios-checkmark-circle" size={70} color={"green"} />
