...
class DeliveryScreen extends React.Component {
  ...
  loadOrders = () => {
    ...
    const query = { deliverystate: { $eq: "ready" } };
  ...
  updateDeliveryState = () => {
    ...
    let stock = mongoClient.db("alzaproc").collection("supplierorders");
      ...
      <List style={style.scene}>
        ...
        <Modal isVisible={this.state.isModalSuccessVisible}>
          <View style={style.modalStyle}>
            ...
            >
              <Button
                style={{ margin: 30, justifyContent: "center", flex: 1 }}
                onPress={() => this.updateDeliveryState}
                success
              >
                <Text
                  style={{
